                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name" value="<?php echo e(old('name')); ?>" placeholder="Nhập tên sản phẩm" required>
...
unset($__errorArgs, $__bag); ?>
    ...
    <input type="number" class="form-control" name="stock_quantity" value="<?php echo e(old('stock_quantity')); ?>" placeholder="Nhập số lượng sản phẩm" min="0" required>
...
<div class="mb-3">
        ...
        <input type="date" class="form-control" name="release_date" value="<?php echo e(old('release_date')); ?>">
    </div>
<div class="mb-3">
        <label class="form-label">Sản phẩm mới nhất</label>
        <select class="form-select" name="is_newest">
            <option value="0" <?php echo e(old('is_newest') == '0' ? 'selected' : ''); ?>>Không</option>
            <option value="1" <?php echo e(old('is_newest') == '1' ? 'selected' : ''); ?>>Có</option>
        </select>
    </div>
<div class="mb-3">
        <label class="form-label">Sản phẩm khuyến mãi</label>
        <select class="form-select" name="is_promotion">
            <option value="0" <?php echo e(old('is_promotion') == '0' ? 'selected' : ''); ?>>Không</option>
            <option value="1" <?php echo e(old('is_promotion') == '1' ? 'selected' : ''); ?>>Có</option>
        </select>
    </div>
<div class="mb-3">
        <label class="form-label">Sản phẩm khuyến mãi</label>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Website_selling_laptops_D-T\resources\views/admin/product-create.blade.php ENDPATH**/ ?>