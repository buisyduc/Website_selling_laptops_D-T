            ...
            <div class="col-xl-4">
                <div class="card border-0 shadow-lg">
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="<?php echo e(route('categories.store')); ?>" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="parent_id" name="parent_id">
                                    ...
                                    <?php echo (new App\Http\Controllers\Admin\CategorieController)->renderCategoryOptions($categories); ?>
            ...
            <div class="col-xl-8">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body p-3">
                        <form method="GET" action="<?php echo e(route('categories')); ?>" class="d-flex gap-2">
                            ...
                            <div class="card h-100 border-0 shadow-sm category-card">
                                ...
                                <div class="card-body p-3 d-flex flex-column">
                                    <div class="flex-grow-1">
                                        <h5 class="card-title mb-2 fw-bold text-truncate"><?php echo e($category->name); ?></h5>
                                        <p class="text-muted small mb-2">
                                            <i class="ri-link me-1"></i><?php echo e($category->slug); ?>
                                        ...
                                        <div class="d-flex justify-content-between align-items-center text-muted small mb-3">
                                            <span><i class="ri-sort-asc me-1"></i>Order: <?php echo e($category->order); ?></span>
                                    ...
                                    <div class="d-flex gap-2 mt-auto">
                                        <button type="button"
                                                ...
                                                data-image="<?php echo e($category->image ? asset('storage/' . $category->image) : ''); ?>"
                                                data-parent_id="<?php echo e($category->parent_id); ?>"
                                                data-parent_name="<?php echo e($category->parent ? $category->parent->name : 'None'); ?>"

                                                data-status="<?php echo e($category->status); ?>"
                                                data-order="<?php echo e($category->order); ?>">
                                            <i class="ri-eye-line me-1"></i>View
                                        </button>
                                        <a href="<?php echo e(route('categories.edit', $category->id)); ?>" class="btn btn-outline-secondary btn-sm flex-fill">
                                            <i class="ri-edit-line me-1"></i>Edit
                                        </a>
                                        <form action="<?php echo e(route('categories.destroy', $category->id)); ?>" method="POST" class="d-inline flex-fill">
                                            <?php echo csrf_field(); ?>
            ...
            document.querySelectorAll('.category-link').forEach(item => {
                item.addEventListener("click", function () {
                    ...
                    if (image) {
                        ...
                        imageElement.src = "<?php echo e(asset('default-image.jpg')); ?>";
                    }
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Website_selling_laptops_D-T\resources\views/admin/Category/categories.blade.php ENDPATH**/ ?>