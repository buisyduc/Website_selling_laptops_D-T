            ...
            <div class="card shadow">
                <div class="card-header bg-white border-bottom d-flex">
                    ...
                    <div
                        ...
                        @if (isset($order))
                            <a href="{{ route('checkout.payment', ['orderId' => $order->id]) }}"
                                class="text-decoration-none text-danger">THANH TOÁN</a>
                        @else
                ...
                <div class="card-body">
                        ...
                        <div class="d-flex align-items-center bg-light p-3 rounded mb-4">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex align-items-center">
                                    <span
                                        class="text-danger fw-bold me-2">{{ number_format($item->variant->price, 0, ',', '.') }}đ</span>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="name" class="form-control"
                                value="{{ old('name', $order->name ?? (auth()->user()->name ?? '')) }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Email</label>
                            <input type="email" name="email" class="form-control"
                                value="{{ old('email', $order->email ?? (auth()->user()->email ?? '')) }}" required>
                        </div>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="d-flex gap-3 mb-3">
                        <div
                            class="form-check flex-fill border border-danger p-3 rounded bg-danger bg-opacity-10 text-center">
                            <input class="form-check-input" type="radio" name="shipping_method" id="delivery"
                                value="home_delivery"
                               {{ old('shipping_method', $order->shipping_method ?? 'home_delivery') == 'home_delivery' ? 'checked' : '' }}>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="province" class="form-control"
                                 ...
                                 value="{{ old('province', $order->province ?? (auth()->user()->province ?? '')) }}" required>
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Quận / Huyện</label>
                            <input type="text" name="district" class="form-control"
                                value="{{ old('district', $order->district ?? '') }}" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" name="ward" class="form-control"
                                value="{{ old('ward', $order->ward ?? '') }}" required>
                        </div>
                        <div class="col-md-6">
