...
@include('client.layouts.partials.head')
  <body>
    ...
    <!-- ========== FOOTER ========== -->
        <!-- BANNER (chỉ hiển thị nếu có section 'banner') -->
        @hasSection('sidebar')
            @yield('sidebar')
        @endif
       ...
       <div class="container">
            ...
            @if (session('success'))
                <div class="alert alert-success alert-dismissible fade show position-fixed top-0 start-50 translate-middle-x mt-3 z-index-9999" role="alert" style="min-width: 300px;">
                    {{ session('success') }}
            ...
            @if (session('message'))
                <div class="alert alert-info alert-dismissible fade show position-fixed top-0 start-50 translate-middle-x mt-3 z-index-9999" role="alert" style="min-width: 300px;">
                    {{ session('message') }}
                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                </div>
            @endif
