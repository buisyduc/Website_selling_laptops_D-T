        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('product.restoreAll') }}" method="POST" class="mb-3 restore-all-form">
                        @csrf
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.querySelectorAll('.restore-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    Swal.fire({
                        ...
                        text: `Sản phẩm "${productName}" sẽ được khôi phục!`,
                        icon: 'warning',
            ...
            document.querySelectorAll('.restore-all-btn').forEach(btn => {
                btn.addEventListener('click', function() {
                    Swal.fire({
                        title: 'Bạn có chắc chắn?',
                        text: "Tất cả sản phẩm đã xóa sẽ được khôi phục!",
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#28a745',
                        cancelButtonColor: '#6c757d',
