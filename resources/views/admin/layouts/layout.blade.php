                                ...
                                <div class="collapse menu-dropdown" id="sidebarProducts">
                                    <ul class="nav nav-sm flex-column">
                                        ...
                                        <li class="nav-item">
                                           ...
                                           <li class="nav-item">
                                            <a href="{{route('attributes')}}" class="nav-link" data-key="t-list-view"> Variation</a>
                                        </li>
                                        </li>
                                          <li class="nav-item">
                                            <a href="{{ route('attributes.trashed') }}" class="nav-link" data-key="t-categories">Soft Deleted Variation</a>
                                        </li>
                                        <li class="nav-item">
