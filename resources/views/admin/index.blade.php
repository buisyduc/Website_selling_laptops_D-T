                            ...
                            <div class="dropdown topbar-head-dropdown topbar-tag-dropdown justify-content-end">
                                <button type="button"
                                    ...
                                    <img id="header-lang-img"
                                        src="https://themesbrand.com/toner/html/assets/images/flags/us.svg"
                                        alt="Header Language" height="16" class="rounded-circle me-2"> <span
                                        id="lang-name">English</span>
                                </button>
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                        ...
                                        <img src="https://themesbrand.com/toner/html/assets/images/flags/spain.svg"
                                            alt="user-image" class="me-2 rounded-circle" height="18">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                        ...
                                        <img src="https://themesbrand.com/toner/html/assets/images/flags/germany.svg"
                                            alt="user-image" class="me-2 rounded-circle" height="18"> <span
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                        ...
                                        <img src="https://themesbrand.com/toner/html/assets/images/flags/italy.svg"
                                            alt="user-image" class="me-2 rounded-circle" height="18">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                        ...
                                        <img src="https://themesbrand.com/toner/html/assets/images/flags/russia.svg"
                                            alt="user-image" class="me-2 rounded-circle" height="18">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                        ...
                                        <img src="https://themesbrand.com/toner/html/assets/images/flags/china.svg"
                                            alt="user-image" class="me-2 rounded-circle" height="18">
                                    ...
                                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                        ...
                                        <img src="https://themesbrand.com/toner/html/assets/images/flags/french.svg"
                                            alt="user-image" class="me-2 rounded-circle" height="18">
                                    ...
                                    <!-- item-->
                                    <a href="javascript:void(0);" class="dropdown-item notify-item language"
                                        data-lang="sa" title="Arabic">
                                        <img src="https://themesbrand.com/toner/html/assets/images/flags/sa.svg"
                                            alt="user-image" class="me-2 rounded-circle" height="18">
                ...
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="{{ route('attributes') }}" class="nav-link"
                                            data-key="t-list-view">Product Variation</a>
                                    </li>
                                    <li class="nav-item">
                                ...
                                <ul class="nav nav-sm flex-column">
                                    ...
                                    <li class="nav-item">
                                        <a href="invoices-list.html" class="nav-link"
                                            data-key="t-list-view">Attributes Product</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link menu-link" href="#sidebarRates" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarRates">
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse menu-dropdown" id="sidebarAccounts">
                                <ul class="nav nav-sm flex-column">
                                    <li class="nav-item">
                                        <a href="account.html" class="nav-link" data-key="t-my-account">My
                                            Account</a>
                                    </li>
                                    <li class="nav-item">
