                            ...
                            <div class="mb-4">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="mt-2" id="image-preview" style="display: none;">
                                        <img id="preview-img" class="rounded border"
                                ...
                                <div class="position-relative overflow-hidden" style="height: 200px;">
                                    @if ($category->image)
                                        <img src="{{ asset('storage/' . $category->image) }}"
                                            alt="{{ $category->name }}" class="card-img-top h-100 object-fit-cover">
                                    @else
                                ...
                                <div class="card-body p-3 d-flex flex-column">
                                    ...
                                    <div class="d-flex gap-2 mt-auto">
                                        <button type="button"
                                            ...
                                            data-title="{{ $category->name }}" data-slug="{{ $category->slug }}"
                                            ...
                                            data-status="{{ $category->status }}" data-order="{{ $category->order }}">
                                        ...
                                        <form action="{{ route('categories.destroy', $category->id) }}" method="POST"
                                            class="d-inline flex-fill form-delete-category">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button"
                                                class="btn btn-outline-danger btn-sm w-100 btn-delete-category"
            ...
            document.querySelectorAll('.btn-delete-category').forEach(function(btn) {
                btn.addEventListener('click', function(e) {
                    ...
                    Swal.fire({
                        ...
                        html: `Bạn có chắc chắn muốn xóa tạm thời danh mục <strong>${categoryName}</strong>?`,
                        icon: 'warning',
