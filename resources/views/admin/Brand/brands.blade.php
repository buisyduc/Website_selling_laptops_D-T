                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-0 bg-transparent">
                            <li class="breadcrumb-item"><a href="javascript:void(0);"
                                    class="text-white-50 text-decoration-none">Sản phẩm</a></li>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text"
                                        ...
                                        id="slug" name="slug" placeholder="slug-tự-động" value="{{ old('slug') }}"
                                        required>
                                    @error('slug')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="mb-4">
                                ...
                                <div class="position-relative">
                                    ...
                                    <div class="mt-2" id="logo-preview" style="display: none;">
                                        <img id="preview-logo" class="rounded border"
            ...
            <div class="col-xl-8">
                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body p-3">
                        <form method="GET" action="{{ route('brands') }}" class="d-flex gap-2">
                            ...
                            <div class="card h-100 border-0 shadow-sm brand-card">
                                ...
                                <div class="card-body p-3 d-flex flex-column">
                                    <div class="flex-grow-1">
                                        <h5 class="card-title mb-2 fw-bold text-truncate">{{ $brand->name }}</h5>
                                        <p class="text-muted small mb-2">
                                            <i class="ri-link me-1"></i>{{ $brand->slug }}
                                        </p>
                                    ...
                                    <div class="d-flex gap-2 mt-auto">
                                        <button type="button" class="btn btn-outline-primary btn-sm flex-fill brand-link"
                                            data-bs-toggle="offcanvas" data-bs-target="#overviewOffcanvas"
                                            data-title="{{ $brand->name }}" data-slug="{{ $brand->slug }}"
                                        ...
                                        <form action="{{ route('brands.destroy', $brand->id) }}" method="POST"
                                            class="d-inline flex-fill form-delete">
                                            @csrf
                                            @method('DELETE')
                                            <button type="button" class="btn btn-outline-danger btn-sm w-100 btn-delete"
