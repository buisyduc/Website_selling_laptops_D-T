                                                ...
                                                <td class="text-center">
                                                    <div class="btn-group" role="group" aria-label="Actions">
                                                        <form action="{{ route('brands.restore', $brand->id) }}"
                                                            method="POST" class="d-inline-block form-restore">
                                                            @csrf
                                                            <button type="button"
                                                                class="btn btn-sm btn-success btn-restore"
                                                                title="Khôi phục danh mục" data-bs-toggle="tooltip">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('brands.restoreAll') }}" method="POST" class="form-restore-all">
                        @csrf
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.btn-restore-all').forEach(function(btn) {
        btn.addEventListener('click', function(e) {
            ...
            Swal.fire({
                title: 'Khôi phục tất cả danh mục?',
